...
function TicketCard({ ticket }) {
  ...
  return (
    <div id="ticket-print" style={{
      background: 'var(--bg2)',
      border: '2px solid #3DA70F',
      borderRadius: '24px',
      overflow: 'hidden',
      maxWidth: '600px',
      margin: '0 auto',
    }}>
      <div style={{ background: '#3DA70F', padding: '20px 28px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
      ...
      <div style={{ padding: '24px 28px', borderBottom: '1px dashed var(--border)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', justifyContent: 'space-between' }}>
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
            <div style={{ color: '#3DA70F', fontSize: '1.4rem' }}>🚌</div>
            <div style={{ height: '2px', width: '100%', background: 'var(--border)', position: 'relative' }}>
              <div style={{ position: 'absolute', top: '-4px', left: '50%', transform: 'translateX(-50%)', width: '10px', height: '10px', background: '#3DA70F', borderRadius: '50%' }} />
            </div>

...
function About() {
  useDocumentMeta({
    title: 'Про нас',
    description: 'Дізнайтесь більше про сервіс BusToRIA — онлайн-бронювання автобусних квитків по Україні',
  })
      ...
      <div style={{ display: 'grid', gap: '20px' }}>
        <section style={sectionStyle}>
          ...
          <p style={{ color: 'var(--text2)', lineHeight: 1.7 }}>
            BusToRIA — це онлайн-сервіс для пошуку та бронювання автобусних квитків
